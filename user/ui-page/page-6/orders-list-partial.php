    ...
    <div id="ordersListWrapper" class="relative">
        ...
        <div id="ordersList"
            ...
            <?php foreach ($orders as $order): ?>
                ...
                <!-- Hidden template — laman ng modal pag binuksan ang order na ito -->
                <template id="order-template-<?= (int) $order['id'] ?>">
                    <div class="px-1">
                        ...
                        <?php elseif (hasActiveBooking($order['bookings'])): ?>
                            ...
                            <?php if (!empty($dateToShow)): ?>
                                <div class="mt-3 flex justify-between items-center text-xs">
                                    ...
                                    <span class="bg-green-50 text-green-700 font-semibold px-2 py-0.5 rounded-md">
