        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-8 max-w-5xl mx-auto">
                        ...
                        <tbody>
                            <tr class="bg-white">
                                <td class="px-4 py-2 font-bold text-slate-800 border-r border-slate-200 text-center">
                                    <?= htmlspecialchars($po['po_number']) ?></td>
                                <td class="px-4 py-2 font-bold text-slate-800 text-center">
                                    <?= date('m/d/Y', strtotime($po['po_date'])) ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="grid grid-cols-2 gap-4 mb-6 text-sm">
                ...
                <div class="border border-slate-300">
                    <div class="bg-slate-700 text-white text-xs font-semibold uppercase tracking-wider px-4 py-2">Customer</div>
                    <?php
                    $custFields = [
                        'Name'          => $po['cust_name'],
                    ...
                    foreach ($custFields as $label => $value): ?>
                        <div class="grid grid-cols-[130px_1fr] border-t border-slate-200">
                            <div class="bg-slate-50 text-xs font-bold uppercase text-slate-600 px-3 py-2 border-r border-slate-200">
                                <?= $label ?></div>
                ...
                <!-- VENDOR -->
                <div class="border border-slate-300">
                    <div class="bg-slate-700 text-white text-xs font-semibold uppercase tracking-wider px-4 py-2">Vendor / Sales Person</div>
                    <?php
                    $vendorFields = [
                    ...
                    <table class="w-full">
                        <tbody>
                            ...
                            <tr class="border-b border-slate-100">
                                ...
                                <td class="px-4 py-2 text-right text-slate-700">
                                    <?= number_format($po['discount_pct'], 2) ?>%</td>
                            </tr>
                            <tr class="border-b border-slate-100">
                                <td class="px-4 py-2 text-slate-500">Amount After Discount:</td>
                                <td class="px-4 py-2 text-right text-slate-700">
                                    PHP <?= number_format($po['subtotal'] - ($po['subtotal'] * $po['discount_pct'] / 100), 2) ?></td>
                            </tr>
                            <tr class="border-b border-slate-100">
                            ...
                            <tr class="border-b border-slate-100">
                                ...
                                <td class="px-4 py-2 text-right text-slate-700">
                                    <?= !empty($po['dp_date']) ? date('m/d/Y', strtotime($po['dp_date'])) : '—' ?></td>
                            </tr>
            ...
            <div class="border border-slate-200 rounded-lg overflow-hidden mt-6">
                <div class="grid grid-cols-5 border-b border-slate-200">
                    <div class="px-3 py-2 bg-slate-700 text-white text-xs font-semibold uppercase tracking-wider text-center border-r border-slate-500">Prepared By</div>
                    <div class="px-3 py-2 bg-slate-700 text-white text-xs font-semibold uppercase tracking-wider text-center border-r border-slate-500">Noted By:</div>
                    <div class="px-3 py-2 bg-slate-700 text-white text-xs font-semibold uppercase tracking-wider text-center border-r border-slate-500">Approved By</div>
                    <div class="px-3 py-2 bg-slate-700 text-white text-xs font-semibold uppercase tracking-wider text-center border-r border-slate-500">Acknowledged By:</div>
                    <div class="px-3 py-2 bg-slate-700 text-white text-xs font-semibold uppercase tracking-wider text-center">Received By</div>
                </div>
                <!-- Signatures -->
                ...
                <div class="grid grid-cols-5">
                    ...
                    <div class="px-3 py-2 border-r border-slate-200 text-center">
                        <p class="text-xs font-semibold text-slate-800">MR. FROILAN BAWAG</p>
                        <p class="text-xs text-slate-500">Sales Associate / Project Manager</p>
                    </div>
