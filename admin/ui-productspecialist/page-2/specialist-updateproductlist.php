    ...
    <div class="ml-60 min-h-screen bg-slate-100 p-6">
        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
            <table class="w-full text-sm" id="products-table">
                <thead>
                    <tr class="border-b border-gray-100 bg-gray-50 text-[10px] font-semibold text-gray-400 uppercase tracking-widest">
                ...
                <tbody id="products-tbody">
                    ...
                    <tr>
                        <td colspan="6" class="px-5 py-12 text-center text-gray-400 text-sm">
                            ...
                            No products yet. <a href="specialist-insertproduct.php" class="text-amber-500 hover:underline">Add one</a>.
                        </td>
                    </tr>
                    <?php else: ?>
                    ...
                    <tr class="product-row border-b border-gray-50 hover:bg-amber-50/40 transition group"
                        ...
                        <td class="px-5 py-3.5">
                            <div class="flex items-center gap-3">
                                ...
                                <?php endif; ?>
                                <div>
                                    <p class="font-semibold text-gray-800 leading-snug"><?= htmlspecialchars($p['name']) ?></p>
                        ...
                        <td class="px-5 py-3.5 text-right">
                            <a href="<?= BASE_URL ?>/ps-updateproductlist?id=<?= $p['id'] ?>"
