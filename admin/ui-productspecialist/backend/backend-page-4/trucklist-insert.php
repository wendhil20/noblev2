<?php
// trucklist-insert.php
// File: admin/ui-productspecialist/backend/backend-page-4/trucklist-insert.php
...
$stmt = $conn->prepare("
    INSERT INTO nobletrucklist
        (nametruck, trucktype, truckvariant, basefare, addperkm, perkmrate,
         length, width, height, maxcubicmeter, maxweightcapacity)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
");
...
if ($stmt->execute()) {
    echo json_encode(['success' => true, 'message' => 'Truck added successfully.', 'id' => $stmt->insert_id]);
} else {
